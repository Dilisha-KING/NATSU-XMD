...
const sessdata = config.SESSION_ID.replace("𝙽𝙰𝚃𝚂𝚄=", '');
...
const port = process.env.PORT || 9090;
  ...
  console.log("𝐍𝐀𝐓𝐒𝐔-𝐌𝐃 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐈𝐍𝐆 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 📍");
  ...
  let up = `> 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃 𝐒𝐔𝐂𝐂𝐄𝐒𝐅𝐔𝐋𝐋𝐘 !!
╭───❍「 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃 𝐊𝐃𝐌𝐃 𝐁𝐎𝐓  」
┃ 𝐍𝐀𝐓𝐒𝐔-𝐌𝐃
╰───────────❍
╭───❍「 *🌐BOT WEB PAGE* 」
┃ https://king-dilisha-ofc-web.pages.dev/
╰───────────❍
╭───❍「 *🫳JOIN CHANNEL* 」
...
┃ ✯ 𝐊𝐈𝐍𝐆 𝐃𝐈𝐋𝐈𝐒𝐇𝐀 𝐓𝐄𝐂𝐇 ㋡
╰───────────❍`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/9mil0t.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawadop = ['94771098429','94775700815'];
...
END:VCARD`,
  ...
  app.get("/", (req, res) => {
  res.send("𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃 𝐍𝐀𝐓𝐒𝐔-𝐌𝐃 𝐁𝐎𝐓 ✔️");
  });
